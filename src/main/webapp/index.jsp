...
<div id="logreg-forms">
    ...
    <form action="/product?action=signup" method="post" class="form-signup">
        <div class="social-login">
        ...
        <input type="text" name="password" id="user-pass" class="form-control" placeholder="Password" required autofocus="">
        <input type="text" name="passwordAgain" id="user-repeatpass" class="form-control" placeholder="Repeat Password" required autofocus="">
